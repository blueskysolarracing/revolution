"""
    ...
    -First conversion after power-up is channel #1 (0x00)
...
class ADC78H89():
    ...
    def run_10ms(self) -> None:
        for ch in channel:
            ...
            ADCCode = (rawData[0] << 8) + rawData[1] #TODO: Need to double-check order that this is received
