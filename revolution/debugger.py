...
def _serialize_contexts(ctx: Any) -> dict[str, Any]:
    ...
    Handles plain dataclass fields as well as computed @property fields
    that live on the Contexts class (e.g. power_battery_min_cell_voltage).
    Non-serializable values (e.g. Direction enum, nested objects) are
    converted to their string representation as a fallback.
    """
    result: dict[str, Any] = {}
